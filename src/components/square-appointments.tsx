...
export default function SquareAppointments() {
  ...
  useEffect(function () {
    const squareWidget = document.querySelector(
  ...
  const resizeFrame = () => {
    const squareFrame = document.querySelector<HTMLElement>(
      "#square-appointments-widget iframe",
    );
    squareFrame.style.height = "3600px";
  ...
  return (
    <div ref={containerRef} id="square-appointments-widget">
      <Script
        ...
        src={
          "https://square.site/appointments/buyer/widget/55ac5595-a22b-46ef-bdea-3f552c1fd2c3/8X0P4KQ71MNP9.js"
        }
        onLoad={resizeFrame}
        async
      />
