...
export default function Page() {
    return (
        <div className="container mx-auto">
            <Image className="mx-auto pb-20" src="/images/mspeeps2.jpg" alt="Ms Peeps" width={500} height={500} />
            ...
            <p className="px-10 py-4 leading-7">Scheduling is easy! Simply click the Book Now button above and select your desired sugar services. You'll be supporting a small woman owned business, our local economy, AND choosing a natural hair removal method that is sweet to the environment and your skin. Bonus: Dottie Grace, Genevieve's gorgeous little shop pup familiar happily comes to work every day as well and is always available for emotional puppy support. <em>Welcome to the sweet side of self care!</em></p>
            <Instafeed />
        </div>
    )
}
